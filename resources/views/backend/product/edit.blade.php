                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body card-dashboard">
                                    <form class="form" id="quickForms" action="{{ route('admin.update.product', $product->id) }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="category_id" id="category_id" class="form-control select2" style="width: 100%;">
                                                            ...
                                                            @foreach($root_categories as $root_category)
                                                                <option {{ $product->category_id == $root_category->id ? 'selected' : '' }} value="{{ $root_category->id }}">{{ $root_category->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="subsubcategory_id" id="subsubcategory_id" class="form-control select2" style="width: 100%;">
                                                            ...
                                                            @foreach($sub_subcategories as $sub_subcategory)
                                                                <option {{ $product->subsubcategory_id == $sub_subcategory->id ? 'selected' : '' }} value="{{ $sub_subcategory->id }}">{{ $sub_subcategory->name }}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="code" class="form-control" id="code" value="{{ $product->code }}" placeholder="Enter Product Code">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="color" class="form-control" id="color" value="{{ $product->color }}" placeholder="Enter Product Color">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="price" class="form-control" id="price" value="{{ $product->price }}" placeholder="Enter Product Price">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="discount" class="form-control" id="discount" value="{{ $product->discount }}" placeholder="Enter Product Discount">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="weight" class="form-control" id="weight" value="{{ $product->weight }}" placeholder="Enter Weight">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select name="fabric" id="fabric" class="form-control select2" style="width: 100%;">
                                                        ...
                                                        @foreach($fabric_array as $fabric)
                                                            <option {{ $product->fabric == $fabric ? 'selected' : '' }} value="{{ $fabric }}">{{ $fabric }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select name="sleeve" id="sleeve" class="form-control select2" style="width: 100%;">
                                                        ...
                                                        @foreach($sleeve_array as $sleeve)
                                                            <option {{ $product->sleeve == $sleeve ? 'selected' : '' }} value="{{ $sleeve }}">{{ $sleeve }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select name="pattern" id="pattern" class="form-control select2" style="width: 100%;">
                                                        ...
                                                        @foreach($pattern_array as $pattern)
                                                            <option {{ $product->pattern == $pattern ? 'selected' : '' }} value="{{ $pattern }}">{{ $pattern }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select name="fit" id="fit" class="form-control select2" style="width: 100%;">
                                                        ...
                                                        @foreach($fit_array as $fit)
                                                            <option {{ $product->fit == $fit ? 'selected' : '' }} value="{{ $fit }}">{{ $fit }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select name="occassion" id="occassion" class="form-control select2" style="width: 100%;">
                                                        ...
                                                        @foreach($occassion_array as $occassion)
                                                            <option {{ $product->occassion == $occassion ? 'selected' : '' }} value="{{ $occassion }}">{{ $occassion }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="stock" class="form-control" id="stock" value="{{ $product->stock }}" placeholder="Enter Stock">
                                                ...
                                                <div class="col-md-12 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" name="main_image" class="form-control dropify" data-max-file-size="2M" data-default-file="{{ $product->main_image ? url($product->main_image) : '' }}" id="main_image" accept="image/*">                                                        <span style="color:red">{{ $errors->has('image') ? $errors->first('image') : '' }}</span>
                                                    </div>
                                                </div>
